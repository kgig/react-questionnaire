...
import QuestionSummaryComponent from './QuestionSummaryComponent';
...
const questionsData: Question[] = [
    {
        ...
        answerSubmit: 'HyperText Markup Language'
    },
    {
        id: nanoid(),
    ...
    },
    {
        ...
        answerSubmit: 'Cascading Style Sheets'
    },
    {
        id: nanoid(),
    ...
    },
    {
        ...
        answerSubmit: 'To refer to the current object'
    },
    {
        id: nanoid(),
    ...
    },
    {
        ...
        answerSubmit: 'To create a new array with the results of calling a provided function on every element'
    },
    {
        id: nanoid(),
    ...
    return (
        <div>
            {questions.map((question, index) => (
                <QuestionSummaryComponent key={question.id} question={question} inx={index}
